...
// Buscar estatísticas
try {
    $totalFuncionarios = $pdo->query("SELECT COUNT(*) as total FROM funcionarios")->fetchColumn();
    $totalTarefas = $pdo->query("SELECT COUNT(*) as total FROM tarefas")->fetchColumn();
    $stmtStatus = $pdo->query("SELECT status, COUNT(*) as total FROM tarefas GROUP BY status");
    $statusTarefas = $stmtStatus->fetchAll(PDO::FETCH_KEY_PAIR); // 'status' => 'total'
} catch (PDOException $e) {
    error_log("Erro ao buscar estatísticas na home: " . $e->getMessage());
    $totalFuncionarios = $totalTarefas = 0;
    $statusTarefas = [];
    echo "<div class='alert alert-warning'>Não foi possível carregar todas as estatísticas.</div>";
}
...
<div class="row">
    <div class="col-md-4 mb-4">
        <div class="card text-white bg-primary h-100">
            ...
            <div class="card-body">
                <h5 class="card-title">Total: <?php echo $totalFuncionarios ?? 'N/A'; ?></h5>
    ...
    <div class="col-md-4 mb-4">
        <div class="card text-white bg-success h-100">
            ...
            <div class="card-body">
                <h5 class="card-title">Total: <?php echo $totalTarefas ?? 'N/A'; ?></h5>
            ...
            <div class="card-body">
                 <ul class="list-unstyled mb-3">
                    <li>
                        ...
                        <?php echo $statusTarefas['a_fazer'] ?? 0; ?>
                    </li>
                    <li>
